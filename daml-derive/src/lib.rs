...
//! ### Prelude
//!
//! All of the above Rust type aliases are defined in the [`prelude`](https://docs.rs/daml/0.1.0/daml/prelude/index.html) module of
...
//! ```
//!
//! The Rust types and methods required to represent this template can be generated by using `daml-codegen` as
//! follows:
//!
//! ```ignore
//! use daml-codegen::daml-codegen;
//! daml-codegen!(dar_file = r"resources/MyDamlApplication.dar");
//! ```
//!
...
//!
//! [`DamlInt64`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlInt64.html
//! [`DamlNumeric`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlNumeric.html
//! [`DamlText`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlText.html
//! [`DamlBool`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlBool.html
//! [`DamlParty`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlParty.html
//! [`DamlDate`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlDate.html
//! [`DamlTime`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlTime.html
//! [`DamlUnit`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlUnit.html
//! [`DamlContractId`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlContractId.html
//! [`DamlList<T>`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlList.html
//! [`DamlTextMap<T>`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlTextMap.html
//! [`DamlOptional<T>`]: https://docs.rs/daml/0.1.0/daml/prelude/type.DamlOptional.html
//! [`DamlCreateCommand`]: https://docs.rs/daml-grpc/0.1.0/daml_grpc/data/command/struct.DamlCreateCommand.html
//! [`DamlExerciseCommand`]: https://docs.rs/daml-grpc/0.1.0/daml_grpc/data/command/struct.DamlExerciseCommand.html
//! [`DamlCommandService`]: https://docs.rs/daml-grpc/0.1.0/daml_grpc/service/struct.DamlCommandService.html
//! [`DamlCommandSubmissionService`]: https://docs.rs/daml-grpc/0.1.0/daml_grpc/service/struct.DamlCommandSubmissionService.html
//! [`DamlCreatedEvent`]: https://docs.rs/daml-grpc/0.1.0/daml_grpc/data/event/struct.DamlCreatedEvent.html
//! [`DamlError`]: https://docs.rs/daml-grpc/0.1.0/daml_grpc/data/enum.DamlError.html
//! [`DamlValue`]: https://docs.rs/daml-grpc/0.1.0/daml_grpc/data/value/enum.DamlValue.html
...
#![doc(html_root_url = "https://docs.rs/daml-derive/0.1.0")]
