...
This crate is guaranteed to compile on stable Rust 1.52 and up.

# Supported DAML Version
These bindings support `DAML-LF` versions `1.6`, `1.7`, `1.8`, `1.11`, `1.12` & `1.13` and have been tested against DAML SDKs up to `1.14.0`.
