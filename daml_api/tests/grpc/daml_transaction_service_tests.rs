...
use daml_api::data::offset::{DamlLedgerOffset, DamlLedgerOffsetBoundary, DamlLedgerOffsetType};
use daml_api::data::value::{DamlRecordField, DamlValue};
use daml_api::data::{DamlError, DamlResult, DamlTransaction, DamlTransactionTree};
use daml_api::service::DamlVerbosity;
...
async fn extract_first_created_event(ledger_client: &DamlLedgerClient) -> DamlResult<DamlTransaction> {
