...
fn test_dalf() -> DamlLfResult<()> {
    let archive =
        DamlLfArchive::from_file("../resources/pingpong_sandbox/archive/PingPongExample/PingPongExample.dalf")?;
...
pub fn test_legacy_dar() -> DamlLfResult<()> {
    let dar = DarFile::from_file("../resources/pingpong_sandbox/archive/PingPongExample.dar")?;
