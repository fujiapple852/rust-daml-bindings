...
/// # }
/// ```
/// [`DamlValue::extract`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#method.extract
/// [`DamlRecord::extract`]: ../../doc/daml-grpc/data/value/struct.DamlRecord.html#method.extract
/// [`DamlValue`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html
/// [`DamlValue`]: daml-grpc::data::value::DamlValue
/// [`DamlRecord`]: ../../doc/daml-grpc/data/value/struct.DamlRecord.html
/// [`DamlRecordField`]: ../../doc/daml-grpc/data/value/struct.DamlRecordField.html
/// [`DamlValue::List`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.List
/// [`DamlValue::Optional`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Optional
/// [`DamlValue::Record`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Record
/// [`DamlValue::Variant`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Variant
/// [`DamlValue::Int64`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Int64
/// [`DamlValue::ContractId`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.ContractId
/// [`DamlValue::Unit`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Unit
/// [`DamlValue::Party`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Party
/// [`DamlValue::Numeric`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Numeric
/// [`DamlValue::Text`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Text
/// [`DamlValue::Timestamp`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Timestamp
/// [`DamlValue::Bool`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Bool
/// [`DamlValue::Date`]: ../../doc/daml-grpc/data/value/enum.DamlValue.html#variant.Date
...
/// [`ListIndexOutOfRange`]: ../../doc/daml-grpc/data/enum.Error.html#variant.ListIndexOutOfRange
/// [`MissingRequiredField`]: ../../doc/daml-grpc/data/enum.Error.html#variant.MissingRequiredField
/// [`UnknownField`]: ../../doc/daml-grpc/data/enum.Error.html#variant.UnknownField
/// [`UnexpectedVariant`]: ../../doc/daml-grpc/data/enum.Error.html#variant.UnexpectedVariant
#[macro_export]
